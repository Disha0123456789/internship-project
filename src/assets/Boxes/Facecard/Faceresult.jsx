...
import personalTraitsImage from '/2nd-row-reading/personal-traits.png';
import lifePurposeImage from '/2nd-row-reading/life-path-and-purpose.png';
import relationCompatibilityImage from '/2nd-row-reading/relationship compatibility.png';
import GrowthImage from '/2nd-row-reading/growth and development.png';
