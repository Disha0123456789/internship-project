...
export default function PoojaDetail() {
    ...
    const questions = [
        { question: "What are the Benefits?", answer: poojaData.benefits ? [poojaData.benefits] : [] },
        { question: "How will it happen?", answer: poojaData.procedure ? [poojaData.procedure] : [] },
        { question: `About ${poojaData.about_deity?.name || "Deity"}`, answer: poojaData.about_deity?.attributes ? [poojaData.about_deity.attributes] : [] },
        { question: "What should you do after pooja to get maximum benefits?", answer: poojaData.max_benefits_actions ? [poojaData.max_benefits_actions] : [] },
                ...
                <div className="FormPuja__Heading">
                    <div className="FormPuja__Heading__Description">
                        ...
                        <p className="pooja-desc">
                            {poojaData.description || "No description available"}
                        </p>
                    </div>
